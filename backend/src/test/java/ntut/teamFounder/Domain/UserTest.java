...
public class UserTest {
    ...
    public void testConstructor() {
        ...
        User user = new User(10L, "113598999", "Mike Wang"
                , "13579", "t113598999@ntut.org.tw", 0, currentDate);
    ...
    public void testIsProfessor() {
        Date currentDate = new Date();
        User user = new User(10L, "113598999", "Mike Wang"
                , "13579", "t113598999@ntut.org.tw", 1, currentDate);
    ...
    public void testGetRoleName() {
        Date currentDate = new Date();
        User user1 = new User(10L, "113598999", "Mike Wang"
                , "13579", "t113598999@ntut.org.tw", 1, currentDate);
        User user2 = new User(10L, "113598999", "Mike Wang"
                , "13579", "t113598999@ntut.org.tw", 0, currentDate);

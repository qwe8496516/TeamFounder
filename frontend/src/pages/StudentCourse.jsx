  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        ...
        const response = await fetch(`http://localhost:8080/api/course/student/${studentId}`)
    ...
    <div className="bg-gray-50 pt-12 pb-4 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto relative">
          <Slider {...settings}>
            {courses.map((course) => (
              <div key={course.id} className="pt-4 px-4 pb-12">
                <div className="relative max-w-sm mx-auto rounded-xl overflow-hidden shadow-lg bg-white hover:shadow-xl transition duration-300 hover:scale-105 flex flex-col">
                  ...
                  <div className="px-6 pb-6">
                    <Link
                      ...
                      className="w-full inline-flex items-center justify-center px-4 py-2 border border-transparent text-bold font-medium rounded-md shadow-sm text-white hover:text-gray-100 bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                    >
